...
export default function Home() {
  ...
  return (
    <main>
      <div className="container mx-auto mt-20 flex flex-col items-center gap-3">
        <div className="flex items-center gap-2">
          <Logo />
          <h1 className="text-2xl font-bold">Gelt</h1>
        </div>
        <div className="m-5 flex h-full flex-col gap-2">
          <h1 className="flex justify-center text-xl font-bold">
            Welcome back
          </h1>
          <p className="text-sm">Welcome back, Please enter your details</p>
        </div>
        <div className="card w-80 rounded-md border bg-white">
